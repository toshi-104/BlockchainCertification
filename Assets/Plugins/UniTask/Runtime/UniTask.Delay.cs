...
namespace Cysharp.Threading.Tasks {
    ...
    public partial struct UniTask {
        ...
        /// </summary>
        public static UniTask NextFrame(PlayerLoopTiming timing = PlayerLoopTiming.Update,
        ...
        public static UniTask DelayFrame(int delayFrameCount, PlayerLoopTiming delayTiming = PlayerLoopTiming.Update,
            ...
            return new UniTask(DelayFramePromise.Create(delayFrameCount, delayTiming, cancellationToken, out var token),
                token);
        }
        ...
        public static UniTask Delay(TimeSpan delayTimeSpan, DelayType delayType,
            ...
            switch (delayType) {
                ...
                case DelayType.Realtime: {
                    return new UniTask(
                        DelayRealtimePromise.Create(delayTimeSpan, delayTiming, cancellationToken, out var token),
                        token);
                }
                case DelayType.DeltaTime:
                default: {
                    return new UniTask(
                        DelayPromise.Create(delayTimeSpan, delayTiming, cancellationToken, out var token), token);
                }
            }
        }
        ...
        sealed class DelayIgnoreTimeScalePromise : IUniTaskSource, IPlayerLoopItem,
