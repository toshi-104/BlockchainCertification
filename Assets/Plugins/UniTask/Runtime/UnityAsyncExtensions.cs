...
namespace Cysharp.Threading.Tasks {
    public static partial class UnityAsyncExtensions {
        ...
        public static UniTask WithCancellation(this AsyncOperation asyncOperation,
            ...
            return new UniTask(
                AsyncOperationWithCancellationSource.Create(asyncOperation, cancellationToken, out var token), token);
        }
        ...
        sealed class AsyncOperationWithCancellationSource : IUniTaskSource, IPlayerLoopItem,
            ITaskPoolNode<AsyncOperationWithCancellationSource> {
            ...
            public static IUniTaskSource Create(AsyncOperation asyncOperation, CancellationToken cancellationToken,
                out short token) {
        ...
        sealed class AsyncOperationConfiguredSource : IUniTaskSource, IPlayerLoopItem,
        ...
        public static UniTask<UnityEngine.Object> WithCancellation(this ResourceRequest asyncOperation,
            CancellationToken cancellationToken) {
            Error.ThrowArgumentNullException(asyncOperation, nameof(asyncOperation));
            if (cancellationToken.IsCancellationRequested)
            ...
            return new UniTask<UnityEngine.Object>(
                ResourceRequestWithCancellationSource.Create(asyncOperation, cancellationToken, out var token), token);
        }
        ...
        sealed class ResourceRequestWithCancellationSource : IUniTaskSource<UnityEngine.Object>, IPlayerLoopItem,
            ITaskPoolNode<ResourceRequestWithCancellationSource> {
            ...
            public static IUniTaskSource<UnityEngine.Object> Create(ResourceRequest asyncOperation,
                CancellationToken cancellationToken, out short token) {
                if (cancellationToken.IsCancellationRequested) {
                    return AutoResetUniTaskCompletionSource<UnityEngine.Object>.CreateFromCanceled(cancellationToken,
                        out token);
                }
        ...
        sealed class ResourceRequestConfiguredSource : IUniTaskSource<UnityEngine.Object>, IPlayerLoopItem,
        ...
        public static UniTask<UnityEngine.Object> ToUniTask(this AssetBundleRequest asyncOperation, IProgress<float> progress
 ...
 default(CancellationToken))
        ...
        public static UniTask<AssetBundle> ToUniTask(this AssetBundleCreateRequest asyncOperation, IProgress<float> progress
 = null, PlayerLoopTiming timing = PlayerLoopTiming.Update, CancellationToken cancellationToken =
 default(CancellationToken))
        {
            Error.ThrowArgumentNullException(asyncOperation, nameof(asyncOperation));
        ...
        public static UnityWebRequestAsyncOperationAwaiter
        ...
        public static UniTask<UnityWebRequest> WithCancellation(this UnityWebRequestAsyncOperation asyncOperation,
            ...
            return new UniTask<UnityWebRequest>(
                UnityWebRequestAsyncOperationWithCancellationSource.Create(asyncOperation, cancellationToken,
                    out var token), token);
        }
        ...
        sealed class UnityWebRequestAsyncOperationWithCancellationSource : IUniTaskSource<UnityWebRequest>,
            IPlayerLoopItem, ITaskPoolNode<UnityWebRequestAsyncOperationWithCancellationSource> {
            ...
            static UnityWebRequestAsyncOperationWithCancellationSource() {
                TaskPool.RegisterSizeGetter(typeof(UnityWebRequestAsyncOperationWithCancellationSource),
                    () => pool.Size);
            }
        ...
        sealed class UnityWebRequestAsyncOperationConfiguredSource : IUniTaskSource<UnityWebRequest>, IPlayerLoopItem,
