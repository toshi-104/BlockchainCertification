...
namespace Cysharp.Threading.Tasks.Triggers {
    ...
    public partial class AsyncTriggerHandler<T> : IAsyncOnAudioFilterReadHandler {
        UniTask<(float[] data, int channels)> IAsyncOnAudioFilterReadHandler.OnAudioFilterReadAsync() {
            core.Reset();
            return new UniTask<(float[] data, int channels)>(
                (IUniTaskSource<(float[] data, int channels)>) (object) this, core.Version);
        }
    }
    ...
    public static partial class AsyncTriggerExtensions {
        public static AsyncControllerColliderHitTrigger
            GetAsyncControllerColliderHitTrigger(this GameObject gameObject) {
    ...
    public sealed class AsyncGUITrigger : AsyncTriggerBase<AsyncUnit> {
        ...
        public UniTask OnGUIAsync(CancellationToken cancellationToken) {
            return ((IAsyncOnGUIHandler) new AsyncTriggerHandler<AsyncUnit>(this, cancellationToken, true))
                .OnGUIAsync();
        }
    }
    ...
    public sealed class AsyncParticleCollisionTrigger : AsyncTriggerBase<GameObject> {
        ...
        public IAsyncOnParticleCollisionHandler
            GetOnParticleCollisionAsyncHandler(CancellationToken cancellationToken) {
    ...
    public static partial class AsyncTriggerExtensions {
        public static AsyncParticleSystemStoppedTrigger
            GetAsyncParticleSystemStoppedTrigger(this GameObject gameObject) {
    ...
    public sealed class AsyncServerInitializedTrigger : AsyncTriggerBase<AsyncUnit> {
        ...
        public IAsyncOnServerInitializedHandler
            GetOnServerInitializedAsyncHandler(CancellationToken cancellationToken) {
            return new AsyncTriggerHandler<AsyncUnit>(this, cancellationToken, false);
        }
    ...
    public sealed class AsyncTransformChildrenChangedTrigger : AsyncTriggerBase<AsyncUnit> {
        ...
        public UniTask OnTransformChildrenChangedAsync(CancellationToken cancellationToken) {
            return ((IAsyncOnTransformChildrenChangedHandler) new AsyncTriggerHandler<AsyncUnit>(this,
                cancellationToken, true)).OnTransformChildrenChangedAsync();
        }
    }
    ...
    public static partial class AsyncTriggerExtensions {
        ...
        public static AsyncTransformParentChangedTrigger
            GetAsyncTransformParentChangedTrigger(this Component component) {
    ...
    public sealed class AsyncResetTrigger : AsyncTriggerBase<AsyncUnit> {
        ...
        public UniTask ResetAsync(CancellationToken cancellationToken) {
            return ((IAsyncResetHandler) new AsyncTriggerHandler<AsyncUnit>(this, cancellationToken, true))
                .ResetAsync();
        }
    }
    ...
    public sealed class AsyncBeginDragTrigger : AsyncTriggerBase<PointerEventData>, IBeginDragHandler {
        ...
        public UniTask<PointerEventData> OnBeginDragAsync() {
            return ((IAsyncOnBeginDragHandler) new AsyncTriggerHandler<PointerEventData>(this, true))
                .OnBeginDragAsync();
        }
    ...
    public sealed class AsyncPointerUpTrigger : AsyncTriggerBase<PointerEventData>, IPointerUpHandler {
        ...
        public UniTask<PointerEventData> OnPointerUpAsync() {
            return ((IAsyncOnPointerUpHandler) new AsyncTriggerHandler<PointerEventData>(this, true))
                .OnPointerUpAsync();
        }
