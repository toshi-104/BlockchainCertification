...
namespace Cysharp.Threading.Tasks.Linq {
    public static partial class UniTaskAsyncEnumerable {
        public static UniTask<double> AverageAsync(this IUniTaskAsyncEnumerable<Int32> source,
        ...
        public static UniTask<double> AverageAsync(this IUniTaskAsyncEnumerable<Int64> source,
            CancellationToken cancellationToken = default) {
            Error.ThrowArgumentNullException(source, nameof(source));
        ...
        public static UniTask<float> AverageAsync(this IUniTaskAsyncEnumerable<Single> source,
            CancellationToken cancellationToken = default) {
            Error.ThrowArgumentNullException(source, nameof(source));
    ...
    internal static class Average {
        public static async UniTask<double> AverageAsync(IUniTaskAsyncEnumerable<Int32> source,
        ...
        public static async UniTask<double> AverageAsync(IUniTaskAsyncEnumerable<Int64> source,
            CancellationToken cancellationToken) {
            long count = 0;
            Int64 sum = 0;
        ...
        public static async UniTask<float> AverageAsync(IUniTaskAsyncEnumerable<Single> source,
            CancellationToken cancellationToken) {
            long count = 0;
            Single sum = 0;
