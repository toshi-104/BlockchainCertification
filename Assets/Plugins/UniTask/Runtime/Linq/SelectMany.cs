...
namespace Cysharp.Threading.Tasks.Linq {
    public static partial class UniTaskAsyncEnumerable {
        public static IUniTaskAsyncEnumerable<TResult> SelectMany<TSource, TResult>(
            this IUniTaskAsyncEnumerable<TSource> source, Func<TSource, IUniTaskAsyncEnumerable<TResult>> selector) {
        ...
        public static IUniTaskAsyncEnumerable<TResult> SelectManyAwaitWithCancellation<TSource, TResult>(
            ...
            return new SelectManyAwaitWithCancellation<TSource, TResult, TResult>(source, selector,
        ...
        public static IUniTaskAsyncEnumerable<TResult> SelectManyAwaitWithCancellation<TSource, TCollection, TResult>(
            ...
            return new SelectManyAwaitWithCancellation<TSource, TCollection, TResult>(source, collectionSelector,
                resultSelector);
        }
    ...
    internal sealed class SelectMany<TSource, TCollection, TResult> : IUniTaskAsyncEnumerable<TResult> {
        ...
        public SelectMany(IUniTaskAsyncEnumerable<TSource> source,
        ...
        sealed class _SelectMany : MoveNextSource, IUniTaskAsyncEnumerator<TResult> {
            ...
            static readonly Action<object> selectedEnumeratorDisposeAsyncCoreDelegate =
            ...
            public _SelectMany(IUniTaskAsyncEnumerable<TSource> source,
                Func<TSource, IUniTaskAsyncEnumerable<TCollection>> selector1,
                Func<TSource, int, IUniTaskAsyncEnumerable<TCollection>> selector2,
                Func<TSource, TCollection, TResult> resultSelector, CancellationToken cancellationToken) {
                this.source = source;
                    ...
                    if (result) {
                        ...
                        if (self.selectedDisposeAsyncAwaiter.IsCompleted) {
                            ...
                            self.selectedDisposeAsyncAwaiter.SourceOnCompleted(
                                selectedEnumeratorDisposeAsyncCoreDelegate, self);
                        }
                    }
                }
            }
    ...
    internal sealed class SelectManyAwait<TSource, TCollection, TResult> : IUniTaskAsyncEnumerable<TResult> {
        ...
        public SelectManyAwait(IUniTaskAsyncEnumerable<TSource> source,
        ...
        sealed class _SelectManyAwait : MoveNextSource, IUniTaskAsyncEnumerator<TResult> {
            ...
            public _SelectManyAwait(IUniTaskAsyncEnumerable<TSource> source,
                ...
                Func<TSource, TCollection, UniTask<TResult>> resultSelector, CancellationToken cancellationToken) {
                this.source = source;
                this.selector1 = selector1;
                this.selector2 = selector2;
                this.resultSelector = resultSelector;
                    ...
                    if (result) {
                        try {
                            ...
                            if (self.selector1 != null) {
                                ...
                                self.collectionSelectorAwaiter = self
                                    .selector2(self.sourceCurrent, checked(self.sourceIndex++)).GetAwaiter();
                            }
            ...
            static void SeletedSourceMoveNextCore(object state) {
                ...
                if (self.TryGetResult(self.selectedAwaiter, out var result)) {
                    if (result) {
                        try {
                            self.resultSelectorAwaiter =
                                self.resultSelector(self.sourceCurrent, self.selectedEnumerator.Current).GetAwaiter();
    ...
    internal sealed class
        ...
        public IUniTaskAsyncEnumerator<TResult> GetAsyncEnumerator(CancellationToken cancellationToken = default) {
            return new _SelectManyAwaitWithCancellation(source, selector1, selector2, resultSelector,
                cancellationToken);
        }
        ...
        sealed class _SelectManyAwaitWithCancellation : MoveNextSource, IUniTaskAsyncEnumerator<TResult> {
                        ...
                        try {
                            ...
                            if (self.selector1 != null) {
                                self.collectionSelectorAwaiter =
                                    self.selector1(self.sourceCurrent, self.cancellationToken).GetAwaiter();
                            }
                            else {
                                self.collectionSelectorAwaiter = self.selector2(self.sourceCurrent,
                                    checked(self.sourceIndex++), self.cancellationToken).GetAwaiter();
                            }
            ...
            static void SeletedSourceMoveNextCore(object state) {
                ...
                if (self.TryGetResult(self.selectedAwaiter, out var result)) {
                    if (result) {
                        try {
                            self.resultSelectorAwaiter = self.resultSelector(self.sourceCurrent,
                                self.selectedEnumerator.Current, self.cancellationToken).GetAwaiter();
                            if (self.resultSelectorAwaiter.IsCompleted) {
                                ResultSelectorAwaitCore(self);
                            }
                            else {
