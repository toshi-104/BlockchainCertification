...
namespace Zenject.SpaceFighter {
    public class PlayerGui : MonoBehaviour {
        ...
        [SerializeField] float _labelWidth;

        [SerializeField] float _labelHeight;

        [SerializeField] float _textureWidth;

        [SerializeField] float _textureHeight;

        [SerializeField] float _killCountOffset;

        [SerializeField] Color _foregroundColor;
