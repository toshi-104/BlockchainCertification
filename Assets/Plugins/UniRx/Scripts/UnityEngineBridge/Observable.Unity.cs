...
namespace UniRx {
    ...
    public class ObservableYieldInstruction<T> : IEnumerator<T>, ICustomYieldInstructionErrorHandler {
        ...
        /// </summary>
        public bool IsDone {
            get { return HasResult || HasError || (cancel.IsCancellationRequested); }
        }
...
#pragma warning restore CS0618
        ...
        static IEnumerator WrapEnumerator(IEnumerator enumerator, IObserver<Unit> observer,
        ...
        static IEnumerator WrapEnumeratorYieldValue<T>(IEnumerator enumerator, IObserver<T> observer,
        ...
        static IEnumerator WrapToCancellableEnumerator<T>(IEnumerator enumerator, IObserver<T> observer,
        ...
        public static IObservable<long> EveryUpdate() {
            return FromMicroCoroutine<long>(
                (observer, cancellationToken) => EveryCycleCore(observer, cancellationToken), FrameCountType.Update);
        }
        ...
        static IEnumerator TimerFrameCore(IObserver<long> observer, int dueTimeFrameCount, int periodFrameCount,
        ...
        static IObservable<T> RepeatUntilCore<T>(this IEnumerable<IObservable<T>> sources, IObservable<Unit> trigger,
        ...
        public static IObservable<UniRx.TimeInterval<T>> FrameTimeInterval<T>(this IObservable<T> source,
