...
namespace UniRx {
    ...
    public class AsyncReactiveCommand<T> : IAsyncReactiveCommand<T> {
        UniRx.InternalUtil.ImmutableList<Func<T, IObservable<Unit>>> asyncActions =
            UniRx.InternalUtil.ImmutableList<Func<T, IObservable<Unit>>>.Empty;
        ...
        public AsyncReactiveCommand(IObservable<bool> canExecuteSource) {
            this.canExecuteSource = new ReactiveProperty<bool>(true);
            this.canExecute = this.canExecuteSource.CombineLatest(canExecuteSource, (x, y) => x && y)
                .ToReactiveProperty();
        }
    ...
    public static class ReactiveCommandExtensions {
        ...
        /// </summary>
        public static IDisposable BindToOnClick(this IReactiveCommand<Unit> command, UnityEngine.UI.Button button,
            Action<Unit> onClick) {
            var d1 = command.CanExecute.SubscribeToInteractable(button);
            var d2 = button.OnClickAsObservable().SubscribeWithState(command, (x, c) => c.Execute(x));
        ...
        public static IDisposable BindToButtonOnClick(this IObservable<bool> canExecuteSource,
            UnityEngine.UI.Button button, Action<Unit> onClick, bool initialValue = true) {
    ...
    public static class AsyncReactiveCommandExtensions {
        ...
        public static System.Runtime.CompilerServices.TaskAwaiter<T> GetAwaiter<T>(
            this IAsyncReactiveCommand<T> command) {
            return command.WaitUntilExecuteAsync(CancellationToken.None).GetAwaiter();
        }
        ...
        /// </summary>
        public static IDisposable BindToOnClick(this IAsyncReactiveCommand<Unit> command, UnityEngine.UI.Button button,
        ...
        /// </summary>
        public static IDisposable BindToOnClick(this UnityEngine.UI.Button button,
            Func<Unit, IObservable<Unit>> asyncOnClick) {
        ...
        /// </summary>
        public static IDisposable BindToOnClick(this UnityEngine.UI.Button button,
            IReactiveProperty<bool> sharedCanExecuteSource, Func<Unit, IObservable<Unit>> asyncOnClick) {
