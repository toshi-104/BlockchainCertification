...
namespace UniRx.Toolkit {
    ...
    public abstract class ObjectPool<T> : IDisposable
        ...
        public IObservable<Unit> PreloadAsync(int preloadCount, int threshold) {
            ...
            return Observable.FromMicroCoroutine<Unit>((observer, cancel) =>
                PreloadCore(preloadCount, threshold, observer, cancel));
        }

        IEnumerator PreloadCore(int preloadCount, int threshold, IObserver<Unit> observer,
